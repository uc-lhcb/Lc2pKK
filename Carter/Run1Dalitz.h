...
// Tue Jun 30 16:19:26 2020 by ROOT version 6.18/00
...
class Run1Dalitz : public TSelector {
public :
   ...
   ClassDef(Run1Dalitz,0);

};

#endif

#ifdef Run1Dalitz_cxx
void Run1Dalitz::Init(TTree *tree)
{
