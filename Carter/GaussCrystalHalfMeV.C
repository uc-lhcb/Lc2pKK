...
Double_t fitval = 0;
     ...
     if (argCry <= -(par[5]) && par[3] > 0. && par[4] > 0.) fitval = LEXP + Gaussian + par[7] + v[0]*par[8];
else if (argCry > par[6] && par[3] > 0. && par[4] > 0.) fitval = HEXP + Gaussian + par[7] + v[0]*par[8];
else if (argCry > -(par[5]) && argCry <= par[6] && par[3] > 0. && par[4] > 0.) fitval = Gauss + Gaussian + par[7] + v[0]*par[8];
