...
CrystalBallFunctionHalfMeV->SetParameter(2, 100000);
CrystalBallFunctionHalfMeV->SetParLimits(2, 2000., 125000.);   
CrystalBallFunctionHalfMeV->SetParameter(3, 2500);
CrystalBallFunctionHalfMeV->SetParLimits(3, 2000., 125000.);   
