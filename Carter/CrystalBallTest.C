...
CrystalBallFunction->SetParameter(2, 10000);   
CrystalBallFunction->SetParameter(3, 2.);
CrystalBallFunction->SetParLimits(3, 0., 30.);   
CrystalBallFunction->SetParameter(4, 2.);
...
c1->cd();
 ...
 TF1 *LcFitSG1 = new TF1("LcFitSG1",CrystalBall,2200.,2400.,6);
 LcFitSG1->SetParameter(0,2287.);
 LcFitSG1->SetParameter(1, 4.);
 LcFitSG1->SetParameter(2, 1.);
 LcFitSG1->SetParLimits(1, 0.,20.);
 LcFitSG1->SetParameter(3, 1.);
 LcFitSG1->SetParameter(4, 0.);
 LcFitSG1->SetParameter(5, 0.);

 TF1 *LcFitSG2 = new TF1("LcFitSG2",CrystalBall,2200.,2400.,6);
 LcFitSG2->SetParameter(0,2287.);
 LcFitSG2->SetParameter(1, 4.);
 LcFitSG2->SetParameter(2, 1.);
 LcFitSG2->SetParLimits(1, 0.,20.);
 LcFitSG2->SetParameter(3, 1.);
 LcFitSG2->SetParameter(4, 0.);
 LcFitSG2->SetParameter(5, 0.);

 TF1 *LcFitSG3 = new TF1("LcFitSG3",CrystalBall,2200.,2400.,6);
 LcFitSG3->SetParameter(0,2287.);
 LcFitSG3->SetParameter(1, 4.);
 LcFitSG3->SetParameter(2, 1.);
 LcFitSG3->SetParLimits(1, 0.,20.);
 LcFitSG3->SetParameter(3, 1.);
 LcFitSG3->SetParameter(4, 0.);
 LcFitSG3->SetParameter(5, 0.);

 TF1 *LcFitSG4 = new TF1("LcFitSG4",CrystalBall,2200.,2400.,6);
 LcFitSG4->SetParameter(0,2287.);
 LcFitSG4->SetParameter(1, 4.);
 LcFitSG4->SetParameter(2, 1.);
 LcFitSG4->SetParLimits(1, 0.,20.);
 LcFitSG4->SetParameter(3, 1.);
 LcFitSG4->SetParameter(4, 0.);
 LcFitSG4->SetParameter(5, 0.);
 
  TF1 *MagDownFitSG = new TF1("MagDownFitSG",CrystalBall,2200.,2400.,6);
 MagDownFitSG->SetParameter(0,2287.);
 MagDownFitSG->SetParameter(1, 4.);
 MagDownFitSG->SetParameter(2, 1.);
 MagDownFitSG->SetParLimits(1, 0.,20.);
 MagDownFitSG->SetParameter(3, 1.);
 MagDownFitSG->SetParameter(4, 0.);
 MagDownFitSG->SetParameter(5, 0.);
 
 TF1 *MagUpFitSG = new TF1("MagUpFitSG",CrystalBall,2200.,2400.,6);
 MagUpFitSG->SetParameter(0,2287.);
 MagUpFitSG->SetParameter(1, 4.);
 MagUpFitSG->SetParameter(2, 1.);
 MagUpFitSG->SetParLimits(1, 0.,20.);
 MagUpFitSG->SetParameter(3, 1.);
 MagUpFitSG->SetParameter(4, 0.);
 MagUpFitSG->SetParameter(5, 0.);
 
 TF1 *ParticleFitSG = new TF1("ParticleFitSG",CrystalBall,2200.,2400.,6);
 ParticleFitSG->SetParameter(0,2287.);
 ParticleFitSG->SetParameter(1, 4.);
 ParticleFitSG->SetParameter(2, 1.);
 ParticleFitSG->SetParLimits(1, 0.,20.);
 ParticleFitSG->SetParameter(3, 1.);
 ParticleFitSG->SetParameter(4, 0.);
 ParticleFitSG->SetParameter(5, 0.);
 
 TF1 *AntiParticleFitSG = new TF1("AntiParticleFitSG",CrystalBall,2200.,2400.,6);
 AntiParticleFitSG->SetParameter(0,2287.);
 AntiParticleFitSG->SetParameter(1, 4.);
 AntiParticleFitSG->SetParameter(2, 1.);
 AntiParticleFitSG->SetParLimits(1, 0.,20.);
 AntiParticleFitSG->SetParameter(3, 1.);
