...
ex1->Clear();
   ...
   Tl.DrawLatex(0.1,0.5,Form("Signal Events: %f Events", CrystalBallFunction->GetParameter(2)));
   Tl.DrawLatex(0.1,0.45,Form("Error: %f Events", CrystalBallFunction->GetParError(2)));
