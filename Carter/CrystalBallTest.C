...
//CrystalBallFunctionHalfMeV->SetParLimits(0,100000, 130000);   
...
double rms = CrystalBallFunctionHalfMeV->GetParameter(2);
double sigmaGauss = CrystalBallFunctionHalfMeV->GetParameter(3);
double fraction = CrystalBallFunctionHalfMeV->GetParameter(4);  
double intercept = CrystalBallFunctionHalfMeV->GetParameter(5);
double slope = CrystalBallFunctionHalfMeV->GetParameter(6);
double CBalpha = CrystalBallFunctionHalfMeV->GetParameter(7);
double CBn = CrystalBallFunctionHalfMeV->GetParameter(8);
...
CrystalBallFunctionHalfMeV->SetParameter(0, signal * 0.90);
...
CrystalBallFunctionHalfMeV->SetParameter(4, fraction * 0.90);
CrystalBallFunctionHalfMeV->SetParLimits(4, 0.001, 0.999);   
CrystalBallFunctionHalfMeV->SetParameter(5, intercept);   
CrystalBallFunctionHalfMeV->SetParameter(6, slope);     
CrystalBallFunctionHalfMeV->SetParameter(7, CBalpha);
CrystalBallFunctionHalfMeV->SetParameter(8, CBn);   
...
CrystalBallFunction1MeV->SetParLimits(2, 10000., 120000.);   
//CrystalBallFunction1MeV->SetParameter(3, 30000);
CrystalBallFunction1MeV->SetParLimits(3, 10000., 120000.);   
CrystalBallFunction1MeV->SetParameter(4, 5.);
CrystalBallFunction1MeV->SetParLimits(4, 0., 10.);   
