...
// The class definition in CrystalBallTest.h has been generated automatically
...
//
// root> T->Process("CrystalBallTest.C")
// root> T->Process("CrystalBallTest.C","some options")
// root> T->Process("CrystalBallTest.C+")
//
