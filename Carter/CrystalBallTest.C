...
CrystalBallFunctionHalfMeV->SetParameter(0,2287.);
CrystalBallFunctionHalfMeV->SetParLimits(0, 2285., 2288.);
CrystalBallFunctionHalfMeV->SetParameter(1, 3.);
CrystalBallFunctionHalfMeV->SetParLimits(1, 0., 8.);
CrystalBallFunctionHalfMeV->SetParameter(2, 80000);
CrystalBallFunctionHalfMeV->SetParLimits(2, 0., 120000.);   
CrystalBallFunctionHalfMeV->SetParameter(3, 30000);
CrystalBallFunctionHalfMeV->SetParLimits(3, 0., 120000.);   
...
CrystalBallFunction1MeV->SetParLimits(1, 0., 8.);
CrystalBallFunction1MeV->SetParameter(2, 80000);
CrystalBallFunction1MeV->SetParLimits(2, 0., 120000.);   
CrystalBallFunction1MeV->SetParameter(3, 30000);
CrystalBallFunction1MeV->SetParLimits(3, 0., 120000.);   
