...
PullPlotHalfMeVDGLoose->GetXaxis()->SetTitleSize(10);  
...
PullPlotHalfMeVDGLoose->GetYaxis()->SetTitleSize(10);
...
PullPlotHalfMeVCBLoose->GetXaxis()->SetTitleSize(10);   
...
PullPlotHalfMeVCBLoose->GetYaxis()->SetTitleSize(10);   
