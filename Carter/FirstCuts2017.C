...
/////////////////////////////
 ...
 grid->SetGridy();
      ...
      gLcP->GetXaxis()->SetBinLabel(11, "(0-70) GeV");
 ...
 c1->cd();
    ...
    gPolarity->GetXaxis()->SetBinLabel(11, "MagDown");
    gPolarity->GetXaxis()->SetBinLabel(90, "MagUp");   
   ...
   grid->cd();
    ...
    gPID->GetXaxis()->SetBinLabel(11, "Particle");
    gPID->GetXaxis()->SetBinLabel(90, "AntiParticle");   
