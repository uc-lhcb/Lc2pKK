...
GaussianLoose->SetParLimits(0, 0, 20000);
...
GaussianLoose->SetParLimits(3, 0, 20000);
...
GaussianMid->SetParLimits(0, 0, 20000);
...
GaussianMid->SetParLimits(3, 0, 20000);
...
GaussianTight->SetParLimits(0, 0, 20000);
...
GaussianTight->SetParLimits(3, 0, 20000);
