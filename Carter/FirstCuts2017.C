...
Bool_t FirstCuts2017::Process(Long64_t entry)
{
   ...
   bool MidCuts = (
      (((*Kminus_ProbNNk)*(*Kplus_ProbNNk)*(*Proton_ProbNNp)) > 0.94)
   && (*Proton_PT > 900)
   && (*Kminus_PT > 750)
   && (*Kplus_PT > 750)
   );
   ...
   bool TightCuts = (
      (((*Kminus_ProbNNk)*(*Kplus_ProbNNk)*(*Proton_ProbNNp)) > 0.97)
   && (*Proton_PT > 900)
   && (*Kminus_PT > 750)
   && (*Kplus_PT > 750)
   );
...
GaussianLooseHalfMeVDG->SetParLimits(0, 0, 60000);
...
GaussianLooseHalfMeVDG->SetParLimits(3, 0, 60000);
...
GaussianMidHalfMeVDG->SetParLimits(0, 0, 60000);
...
GaussianMidHalfMeVDG->SetParLimits(3, 0, 60000);
...
GaussianTightHalfMeVDG->SetParLimits(0, 0, 60000);
...
GaussianTightHalfMeVDG->SetParLimits(3, 0, 60000);
...
GaussianLoose1MeVDG->SetParLimits(0, 0, 60000);
...
GaussianLoose1MeVDG->SetParLimits(3, 0, 60000);
...
GaussianMid1MeVDG->SetParLimits(0, 0, 60000);
...
GaussianMid1MeVDG->SetParLimits(3, 0, 60000);
...
GaussianTight1MeVDG->SetParLimits(0, 0, 60000);
...
GaussianTight1MeVDG->SetParLimits(3, 0, 60000);
