...
// Fri Jul  3 16:30:01 2020 by ROOT version 6.18/00
// from TChain Lc2pKKTuple/DecayTree/
//////////////////////////////////////////////////////////

#ifndef BSubAnalysis_h
#define BSubAnalysis_h
...
class BSubAnalysis : public TSelector {
public :
   ...
   BSubAnalysis(TTree * /*tree*/ =0) { }
   virtual ~BSubAnalysis() { }
   ...
   ClassDef(BSubAnalysis,0);

};

#endif

#ifdef BSubAnalysis_cxx
void BSubAnalysis::Init(TTree *tree)
{
