...
void LcMass::SlaveBegin(TTree * /*tree*/)
{
   ...
   FinalMass = new TH1D("", "", 200, 2262, 2312);
   FinalMass->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   FinalMass->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   PolarityMagUp = new TH1D("", "", 200, 2262, 2312);
   PolarityMagUp->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   PolarityMagUp->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   PolarityMagDown = new TH1D("", "", 200, 2262, 2312);
   PolarityMagDown->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   PolarityMagDown->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   Particle = new TH1D("", "", 200, 2262, 2312);
   Particle->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   Particle->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   AntiParticle = new TH1D("", "", 200, 2262, 2312);
   AntiParticle->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   AntiParticle->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcP1 = new TH1D("", "", 200, 2262, 2312);
   LcP1->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcP1->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcP2 = new TH1D("", "", 200, 2262, 2312);
   LcP2->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcP2->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcP3 = new TH1D("", "", 200, 2262, 2312);
   LcP3->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcP3->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcP4 = new TH1D("", "", 200, 2262, 2312);
   LcP4->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcP4->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcTau1 = new TH1D("", "", 200, 2262, 2312);
   LcTau1->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcTau1->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcTau2 = new TH1D("", "", 200, 2262, 2312);
   LcTau2->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcTau2->GetYaxis()->SetTitle("Events Per 1/4 MeV");

   LcTau3 = new TH1D("", "", 200, 2262, 2312);
   LcTau3->GetXaxis()->SetTitle("m(pK^{-}K^{+}) [MeV]");
   LcTau3->GetYaxis()->SetTitle("Events Per 1/4 MeV");
