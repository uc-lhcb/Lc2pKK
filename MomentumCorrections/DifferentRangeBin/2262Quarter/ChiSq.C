...
LcTau3->SetLineWidth(2);
    ...
    pad2->Draw();
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* FinalPull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
      ...
      pad2->cd();
      pad2->Clear();
      TH1D* MagUpPull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          pad2->cd();
          pad2->Clear();
          TH1D* MagDownPull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* ParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* AntiParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP1Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
  LcP1Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcP2Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
    LcP2Pull->SetStats(0);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* LcP3Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
        LcP3Pull->SetStats(0);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP4Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
  LcP4Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau1Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau2Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau3Pull = new TH1D("Mass [MeV]", "Lc Mass", 200, 2262, 2312);
