...
void LcMass::SlaveBegin(TTree * /*tree*/)
{
   ...
   FinalMass = new TH1D("", "", 130, 2222, 2352);
   FinalMass->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   FinalMass->GetYaxis()->SetTitle("Events Per 1 MeV");

   PolarityMagUp = new TH1D("", "", 130, 2222, 2352);
   PolarityMagUp->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   PolarityMagUp->GetYaxis()->SetTitle("Events Per 1 MeV");

   PolarityMagDown = new TH1D("", "", 130, 2222, 2352);
   PolarityMagDown->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   PolarityMagDown->GetYaxis()->SetTitle("Events Per 1 MeV");

   Particle = new TH1D("", "", 130, 2222, 2352);
   Particle->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   Particle->GetYaxis()->SetTitle("Events Per 1 MeV");

   AntiParticle = new TH1D("", "", 130, 2222, 2352);
   AntiParticle->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   AntiParticle->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcP1 = new TH1D("", "", 130, 2222, 2352);
   LcP1->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcP1->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcP2 = new TH1D("", "", 130, 2222, 2352);
   LcP2->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcP2->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcP3 = new TH1D("", "", 130, 2222, 2352);
   LcP3->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcP3->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcP4 = new TH1D("", "", 130, 2222, 2352);
   LcP4->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcP4->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcTau1 = new TH1D("", "", 130, 2222, 2352);
   LcTau1->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcTau1->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcTau2 = new TH1D("", "", 130, 2222, 2352);
   LcTau2->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcTau2->GetYaxis()->SetTitle("Events Per 1 MeV");

   LcTau3 = new TH1D("", "", 130, 2222, 2352);
   LcTau3->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
   LcTau3->GetYaxis()->SetTitle("Events Per 1 MeV");
