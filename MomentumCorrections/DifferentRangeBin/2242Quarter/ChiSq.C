...
#include "DoubleGaussExpQuarter.C"
...
void ChiSq::Terminate()
{
  ...
  LcTau3->SetLineWidth(2);
      ...
      c1->cd();
      FinalMass->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      PolarityMagUp->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      PolarityMagDown->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      Particle->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      AntiParticle->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcP1->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcP2->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcP3->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcP4->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcTau1->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcTau2->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
      LcTau3->GetYaxis()->SetTitle("Entries / (0.25 MeV)");
    ...
    pad2->Draw();
        ...
        TF1 *FinalFit = new TF1("FinalFit",DoubleGaussExp,2242, 2332,7);
        FinalFit->SetParameter(0, 0.4);
        FinalFit->SetParLimits(0, 0.01, 0.99);
        FinalFit->SetParameter(1, 10000);
        FinalFit->SetParameter(2, 2287.);
        FinalFit->SetParameter(3, 4);
        FinalFit->SetParameter(4, 7);
        FinalFit->SetParLimits(3, 1, 18);
        FinalFit->SetParLimits(4, 1, 18);
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* FinalPull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
      ...
      TF1 *MagUpFit = new TF1("MagUpFit",DoubleGaussExp,2242, 2332,7);
      ...
      MagUpFit->SetParLimits(3, 1, 18);
      MagUpFit->SetParLimits(4, 1, 18);
      ...
      pad2->cd();
      pad2->Clear();
      TH1D* MagUpPull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          TF1 *MagDownFit = new TF1("MagDownFit",DoubleGaussExp,2242, 2332,7);
          ...
          MagDownFit->SetParLimits(3, 1, 18);
          MagDownFit->SetParLimits(4, 1, 18);
          ...
          pad2->cd();
          pad2->Clear();
          TH1D* MagDownPull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
    ...
    TF1 *ParticleFit = new TF1("ParticleFit",DoubleGaussExp,2242, 2332,7);
    ...
    ParticleFit->SetParLimits(3, 1, 18);
    ParticleFit->SetParLimits(4, 1, 18);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* ParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        TF1 *AntiParticleFit = new TF1("AntiParticleFit",DoubleGaussExp,2242, 2332,7);
        ...
        AntiParticleFit->SetParLimits(3, 1, 18);
        AntiParticleFit->SetParLimits(4, 1, 18);
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* AntiParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
  ...
  TF1 *LcP1Fit = new TF1("LcP1Fit",DoubleGaussExp,2242, 2332,7);
  ...
  LcP1Fit->SetParLimits(3, 1, 18);
  LcP1Fit->SetParLimits(4, 1, 18);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP1Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
  LcP1Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    TF1 *LcP2Fit = new TF1("LcP2Fit",DoubleGaussExp,2242, 2332,7);
    ...
    LcP2Fit->SetParLimits(3, 1, 18);
    LcP2Fit->SetParLimits(4, 1, 18);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcP2Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
    LcP2Pull->SetStats(0);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        TF1 *LcP3Fit = new TF1("LcP3Fit",DoubleGaussExp,2242, 2332,7);
        ...
        LcP3Fit->SetParLimits(3, 1, 18);
        LcP3Fit->SetParLimits(4, 1, 18);
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* LcP3Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
        LcP3Pull->SetStats(0);
  ...
  TF1 *LcP4Fit = new TF1("LcP4Fit",DoubleGaussExp,2242, 2332,7);
  ...
  LcP4Fit->SetParLimits(3, 1, 18);
  LcP4Fit->SetParLimits(4, 1, 18);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP4Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
  LcP4Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    TF1 *LcTau1Fit = new TF1("LcTau1Fit",DoubleGaussExp,2242, 2332,7);
    ...
    LcTau1Fit->SetParLimits(3, 1, 18);
    LcTau1Fit->SetParLimits(4, 1, 18);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau1Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
    ...
    TF1 *LcTau2Fit = new TF1("LcTau2Fit",DoubleGaussExp,2242, 2332,7);
    ...
    LcTau2Fit->SetParLimits(3, 1, 18);
    LcTau2Fit->SetParLimits(4, 1, 18);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau2Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
    ...
    TF1 *LcTau3Fit = new TF1("LcTau3Fit",DoubleGaussExp,2242, 2332,7);
    ...
    LcTau3Fit->SetParLimits(3, 1, 18);
    LcTau3Fit->SetParLimits(4, 1, 18);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau3Pull = new TH1D("Mass [MeV]", "Lc Mass", 360, 2242, 2332);
