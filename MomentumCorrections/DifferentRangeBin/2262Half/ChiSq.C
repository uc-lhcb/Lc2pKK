...
LcTau3->SetLineWidth(2);
    ...
    pad2->Draw();
        ...
        TF1 *FinalFit = new TF1("FinalFit",DoubleGaussExp,2262, 2312,7);
...
//        lt->DrawLatexNDC(0.25, 0.60, "#color[4]{LHCb #Lambda_{c} Mass}");
//        lt->DrawLatexNDC(0.25, 0.55, "#color[419]{PDG #Lambda_{c} Mass}");
        lt->DrawLatexNDC(0.62, 0.70, "Signal = "+SignalDGH+" #pm "+SignalErDGH+"");
        lt->DrawLatexNDC(0.62, 0.65, "Fraction in #sigma_{1} = "+FractionDGH+" #pm "+FractionErDGH+"");
        lt->DrawLatexNDC(0.62, 0.60, "#mu = "+muDGH+" #pm "+muErDGH+" MeV");
        lt->DrawLatexNDC(0.62, 0.55, "#sigma_{1} = "+sigma1DGH+" #pm "+sigma1ErDGH+" MeV");
        lt->DrawLatexNDC(0.62, 0.50, "#sigma_{2} = "+rmsDGH+" #pm "+rmsErDGH+" MeV");
        TLine *line1 = new TLine(2286.46,0,2286.46,4600);
        TLine *line2 = new TLine(2287.412,0,2287.412,5000);
  ...
  //      line2->Draw();
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* FinalPull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
      ...
      TF1 *MagUpFit = new TF1("MagUpFit",DoubleGaussExp,2262, 2312,7);
      ...
      pad2->cd();
      pad2->Clear();
      TH1D* MagUpPull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          TF1 *MagDownFit = new TF1("MagDownFit",DoubleGaussExp,2262, 2312,7);
          ...
          pad2->cd();
          pad2->Clear();
          TH1D* MagDownPull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
    ...
    TF1 *ParticleFit = new TF1("ParticleFit",DoubleGaussExp,2262, 2312,7);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* ParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        TF1 *AntiParticleFit = new TF1("AntiParticleFit",DoubleGaussExp,2262, 2312,7);
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* AntiParticlePull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
  ...
  TF1 *LcP1Fit = new TF1("LcP1Fit",DoubleGaussExp,2262, 2312,7);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP1Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
  LcP1Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    TF1 *LcP2Fit = new TF1("LcP2Fit",DoubleGaussExp,2262, 2312,7);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcP2Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
    LcP2Pull->SetStats(0);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        TF1 *LcP3Fit = new TF1("LcP3Fit",DoubleGaussExp,2262, 2312,7);
        ...
        pad2->cd();
        pad2->Clear();
        TH1D* LcP3Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
        LcP3Pull->SetStats(0);
  ...
  TF1 *LcP4Fit = new TF1("LcP4Fit",DoubleGaussExp,2262, 2312,7);
  ...
  pad2->cd();
  pad2->Clear();
  TH1D* LcP4Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
  LcP4Pull->SetStats(0);
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    TF1 *LcTau1Fit = new TF1("LcTau1Fit",DoubleGaussExp,2262, 2312,7);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau1Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
    ...
    TF1 *LcTau2Fit = new TF1("LcTau2Fit",DoubleGaussExp,2262, 2312,7);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau2Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
    ...
    TF1 *LcTau3Fit = new TF1("LcTau3Fit",DoubleGaussExp,2262, 2312,7);
    ...
    pad2->cd();
    pad2->Clear();
    TH1D* LcTau3Pull = new TH1D("Mass [MeV]", "Lc Mass", 100, 2262, 2312);
