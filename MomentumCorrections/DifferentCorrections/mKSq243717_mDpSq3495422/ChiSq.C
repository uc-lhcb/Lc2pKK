...
void ChiSq::Terminate()
{
    ...
    pad2->Draw();
        ...
        lt->DrawLatexNDC(0.58, 0.65, "Fraction in First = "+FractionDGH+" #pm "+FractionErDGH+"");
        ...
        FinalPull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
      ...
      MagUpPull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          MagDownPull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
    ...
    ParticlePull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        AntiParticlePull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
  ...
  LcP1Pull->SetStats(0);
  LcP1Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    LcP2Pull->SetStats(0);
    LcP2Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        LcP3Pull->SetStats(0);
        LcP3Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
  ...
  LcP4Pull->SetStats(0);
  LcP4Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    LcTau1Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
    ...
    LcTau2Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
    ...
    LcTau3Pull->GetXaxis()->SetTitle("Mass of p^{+}K^{+}K^{-} [MeV]");
