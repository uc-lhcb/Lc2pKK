...
#include "DoubleGaussLinearHalf.C"
...
void ChiSq::Terminate()
{
    ...
    pad2->Draw();
        ...
        TF1 *FinalFit = new TF1("FinalFit",DoubleGaussLinear,2222, 2352,7);
        ...
        FinalFit->SetParameter(5, 0);
        FinalFit->SetParameter(6, 0);
      ...
      TF1 *MagUpFit = new TF1("MagUpFit",DoubleGaussLinear,2222, 2352,7);
      MagUpFit->SetParameter(0, 0.4);
      MagUpFit->SetParLimits(0, 0.01, 0.99);
      MagUpFit->SetParameter(1, 100000);
      ...
      MagUpFit->SetParameter(5, 0);
      MagUpFit->SetParameter(6, 0);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          TF1 *MagDownFit = new TF1("MagDownFit",DoubleGaussLinear,2222, 2352,7);
          ...
          MagDownFit->SetParameter(5, 0);
          MagDownFit->SetParameter(6, 0);
    ...
    TF1 *ParticleFit = new TF1("ParticleFit",DoubleGaussLinear,2222, 2352,7);
    ...
    ParticleFit->SetParameter(5, 0);
    ParticleFit->SetParameter(6, 0);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        TF1 *AntiParticleFit = new TF1("AntiParticleFit",DoubleGaussLinear,2222, 2352,7);
        ...
        AntiParticleFit->SetParameter(5, 0);
        AntiParticleFit->SetParameter(6, 0);
  ...
  TF1 *LcP1Fit = new TF1("LcP1Fit",DoubleGaussLinear,2222, 2352,7);
  ...
  LcP1Fit->SetParameter(5, 0);
  LcP1Fit->SetParameter(6, 0);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    TF1 *LcP2Fit = new TF1("LcP2Fit",DoubleGaussLinear,2222, 2352,7);
    ...
    LcP2Fit->SetParameter(5, 0);
    LcP2Fit->SetParameter(6, 0);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        TF1 *LcP3Fit = new TF1("LcP3Fit",DoubleGaussLinear,2222, 2352,7);
        ...
        LcP3Fit->SetParameter(5, 0);
        LcP3Fit->SetParameter(6, 0);
  ...
  TF1 *LcP4Fit = new TF1("LcP4Fit",DoubleGaussLinear,2222, 2352,7);
  ...
  LcP4Fit->SetParameter(5, 0);
  LcP4Fit->SetParameter(6, 0);
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    TF1 *LcTau1Fit = new TF1("LcTau1Fit",DoubleGaussLinear,2222, 2352,7);
    ...
    LcTau1Fit->SetParameter(5, 0);
    LcTau1Fit->SetParameter(6, 0);
    ...
    TF1 *LcTau2Fit = new TF1("LcTau2Fit",DoubleGaussLinear,2222, 2352,7);
    ...
    LcTau2Fit->SetParameter(5, 0);
    LcTau2Fit->SetParameter(6, 0);
    ...
    TF1 *LcTau3Fit = new TF1("LcTau3Fit",DoubleGaussLinear,2222, 2352,7);
    ...
    LcTau3Fit->SetParameter(5, 0);
    LcTau3Fit->SetParameter(6, 0);
