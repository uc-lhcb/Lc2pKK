...
void ChiSq::Terminate()
{
    ...
    pad2->Draw();
        ...
        TF1 *FinalFit = new TF1("FinalFit",DoubleGaussQuadNew,2222, 2352,8);
        ...
        FinalFit->SetParameter(5, -100);
        FinalFit->SetParameter(6, 0.07);
        FinalFit->SetParameter(7, 0.00001);
      ...
      TF1 *MagUpFit = new TF1("MagUpFit",DoubleGaussQuadNew,2222, 2352,8);
      ...
      MagUpFit->SetParameter(5, -50);
      MagUpFit->SetParameter(6, 0.03);
      MagUpFit->SetParameter(7, 0.00001);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          TF1 *MagDownFit = new TF1("MagDownFit",DoubleGaussQuadNew,2222, 2352,8);
          ...
          MagDownFit->SetParameter(5, -50);
          MagDownFit->SetParameter(6, 0.03);
          MagDownFit->SetParameter(7, 0.00001);
    ...
    TF1 *ParticleFit = new TF1("ParticleFit",DoubleGaussQuadNew,2222, 2352,8);
    ...
    ParticleFit->SetParameter(5, -60);
    ParticleFit->SetParameter(6, 0.04);
    ParticleFit->SetParameter(7, 0.00001);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        TF1 *AntiParticleFit = new TF1("AntiParticleFit",DoubleGaussQuadNew,2222, 2352,8);
        ...
        AntiParticleFit->SetParameter(5, -50);
        AntiParticleFit->SetParameter(6, 0.03);
        AntiParticleFit->SetParameter(7, 0.00001);
  ...
  TF1 *LcP1Fit = new TF1("LcP1Fit",DoubleGaussQuadNew,2222, 2352,8);
  ...
  LcP1Fit->SetParameter(5, -40);
  LcP1Fit->SetParameter(6, 0.02);
  LcP1Fit->SetParameter(7, 0.00001);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    TF1 *LcP2Fit = new TF1("LcP2Fit",DoubleGaussQuadNew,2222, 2352,8);
    ...
    LcP2Fit->SetParameter(5, -40);
    LcP2Fit->SetParameter(6, 0.02);
    LcP2Fit->SetParameter(7, 0.00001);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        TF1 *LcP3Fit = new TF1("LcP3Fit",DoubleGaussQuadNew,2222, 2352,8);
        ...
        LcP3Fit->SetParameter(5, -50);
        LcP3Fit->SetParameter(6, 0.01);
        LcP3Fit->SetParameter(7, 0.00001);
  ...
  TF1 *LcP4Fit = new TF1("LcP4Fit",DoubleGaussQuadNew,2222, 2352,8);
  ...
  LcP4Fit->SetParameter(5, -40);
  LcP4Fit->SetParameter(6, 0.03);
  LcP4Fit->SetParameter(7, 0.00001);
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    TF1 *LcTau1Fit = new TF1("LcTau1Fit",DoubleGaussQuadNew,2222, 2352,8);
    ...
    LcTau1Fit->SetParameter(5, -80);
    LcTau1Fit->SetParameter(6, 0.04);
    LcTau1Fit->SetParameter(7, 0.00001);
    ...
    TF1 *LcTau2Fit = new TF1("LcTau2Fit",DoubleGaussQuadNew,2222, 2352,8);
    ...
    LcTau2Fit->SetParameter(5, -1);
    LcTau2Fit->SetParameter(6, 0.006);
    LcTau2Fit->SetParameter(7, 0.00001);
    ...
    TF1 *LcTau3Fit = new TF1("LcTau3Fit",DoubleGaussQuadNew,2222, 2352,8);
    ...
    LcTau3Fit->SetParameter(5, -20);
    LcTau3Fit->SetParameter(6, 0.02);
    LcTau3Fit->SetParameter(7, 0.00001);
