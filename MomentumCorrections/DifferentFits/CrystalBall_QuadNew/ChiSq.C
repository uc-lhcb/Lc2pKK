...
#include "CrystalGaussQuadNewHalf.C"
...
void ChiSq::SlaveBegin(TTree * /*tree*/)
{
   ...
   LcTau3 = (TH1D*) MassHistograms->Get("Lc_M_LcTau3");
     ...
     File = new TFile("Deviations.root", "RECREATE");
     gFile = File;
...
ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls(10000);
  ...
  LcTau3->SetLineWidth(2);
    ...
    pad2->Draw();
        ...
        TF1 *FinalFit = new TF1("FinalFit",CrystalGaussQuad,2222, 2352,10);
        FinalFit->SetParameter(0, 100000);
        FinalFit->SetParLimits(0, 10000, 110000);
        FinalFit->SetParameter(1, 2287);
        FinalFit->SetParameter(2, 3.5);
        FinalFit->SetParameter(3, 4);
        FinalFit->SetParameter(4, 0.2);
        FinalFit->SetParLimits(4, 0.001, 0.99999);
        FinalFit->SetParameter(5, 45);
        FinalFit->SetParameter(6, 0.001);
        FinalFit->SetParameter(7, -0.001);
        FinalFit->SetParameter(8, 5);
        FinalFit->SetParameter(9, 1.1);
        FinalFit->SetParLimits(8, 0.00000001, 10);
        FinalFit->SetParLimits(9, 1.00000001, 10);
        ...
        lt->DrawLatexNDC(0.58, 0.70, "Signal = "+SignalCBH+" #pm "+SignalErCBH+"");
        lt->DrawLatexNDC(0.58, 0.65, "Fraction in Gauss = "+FractionCBH+" #pm "+FractionErCBH+"");
        lt->DrawLatexNDC(0.58, 0.60, "#mu = "+muCBH+" #pm "+muErCBH+" MeV");
        lt->DrawLatexNDC(0.58, 0.55, "#sigma_{G} = "+sigma1CBH+" #pm "+sigma1ErCBH+" MeV");
        lt->DrawLatexNDC(0.58, 0.50, "rms = "+rmsCBH+" #pm "+rmsErCBH+" MeV");
      ...
      TF1 *MagUpFit = new TF1("MagUpFit",CrystalGaussQuad,2222, 2352,10);
      MagUpFit->SetParameter(0, 50000);
      MagUpFit->SetParLimits(0, 10000, 100000);
      MagUpFit->SetParameter(1, 2287);
      MagUpFit->SetParameter(2, 3.5);
      MagUpFit->SetParameter(3, 4);
      MagUpFit->SetParameter(4, 0.2);
      MagUpFit->SetParLimits(4, 0.001, 0.99999);
      MagUpFit->SetParameter(5, 20);
      MagUpFit->SetParameter(6, 0.001);
      MagUpFit->SetParameter(7, -0.001);
      MagUpFit->SetParameter(8, 5);
      MagUpFit->SetParameter(9, 1.1);
      MagUpFit->SetParLimits(8, 0.00000001, 10);
      MagUpFit->SetParLimits(9, 1.00000001, 10);
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          TF1 *MagDownFit = new TF1("MagDownFit",CrystalGaussQuad,2222, 2352,10);
          MagDownFit->SetParameter(0, 50000);
          MagDownFit->SetParLimits(0, 10000, 100000);
          MagDownFit->SetParameter(1, 2287);
          MagDownFit->SetParameter(2, 3.5);
          MagDownFit->SetParameter(3, 4);
          MagDownFit->SetParameter(4, 0.2);
          MagDownFit->SetParLimits(4, 0.001, 0.99999);
          MagDownFit->SetParameter(5, 20);
          MagDownFit->SetParameter(6, 0.001);
          MagDownFit->SetParameter(7, -0.001);
          MagDownFit->SetParameter(8, 5);
          MagDownFit->SetParameter(9, 1.1);
          MagDownFit->SetParLimits(8, 0.00000001, 10);
          MagDownFit->SetParLimits(9, 1.00000001, 10);
    ...
    TF1 *ParticleFit = new TF1("ParticleFit",CrystalGaussQuad,2222, 2352,10);
    ParticleFit->SetParameter(0, 50000);
    ParticleFit->SetParLimits(0, 10000, 100000);
    ParticleFit->SetParameter(1, 2287);
    ParticleFit->SetParameter(2, 3.5);
    ParticleFit->SetParameter(3, 4);
    ParticleFit->SetParameter(4, 0.2);
    ParticleFit->SetParLimits(4, 0.001, 0.99999);
    ParticleFit->SetParameter(5, 20);
    ParticleFit->SetParameter(6, 0.001);
    ParticleFit->SetParameter(7, -0.001);
    ParticleFit->SetParameter(8, 5);
    ParticleFit->SetParameter(9, 1.1);
    ParticleFit->SetParLimits(8, 0.00000001, 10);
    ParticleFit->SetParLimits(9, 1.00000001, 10);
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        TF1 *AntiParticleFit = new TF1("AntiParticleFit",CrystalGaussQuad,2222, 2352,10);
        AntiParticleFit->SetParameter(0, 50000);
        AntiParticleFit->SetParLimits(0, 10000, 100000);
        AntiParticleFit->SetParameter(1, 2287);
        AntiParticleFit->SetParameter(2, 3.5);
        AntiParticleFit->SetParameter(3, 4);
        AntiParticleFit->SetParameter(4, 0.2);
        AntiParticleFit->SetParLimits(4, 0.001, 0.99999);
        AntiParticleFit->SetParameter(5, 20);
        AntiParticleFit->SetParameter(6, 0.001);
        AntiParticleFit->SetParameter(7, -0.001);
        AntiParticleFit->SetParameter(8, 5);
        AntiParticleFit->SetParameter(9, 1.1);
        AntiParticleFit->SetParLimits(8, 0.00000001, 10);
        AntiParticleFit->SetParLimits(9, 1.00000001, 10);
  ...
  TF1 *LcP1Fit = new TF1("LcP1Fit",CrystalGaussQuad,2222, 2352,10);
  LcP1Fit->SetParameter(0, 20000);
  LcP1Fit->SetParLimits(0, 10000, 100000);
  LcP1Fit->SetParameter(1, 2287);
  LcP1Fit->SetParameter(2, 3.5);
  LcP1Fit->SetParameter(3, 4);
  LcP1Fit->SetParameter(4, 0.2);
  LcP1Fit->SetParLimits(4, 0.001, 0.99999);
  LcP1Fit->SetParameter(5, 10);
  LcP1Fit->SetParameter(6, 0.001);
  LcP1Fit->SetParameter(7, -0.001);
  LcP1Fit->SetParameter(8, 5);
  LcP1Fit->SetParameter(9, 1.1);
  LcP1Fit->SetParLimits(8, 0.00000001, 10);
  LcP1Fit->SetParLimits(9, 1.00000001, 10);
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    TF1 *LcP2Fit = new TF1("LcP2Fit",CrystalGaussQuad,2222, 2352,10);
    LcP2Fit->SetParameter(0, 20000);
    LcP2Fit->SetParLimits(0, 10000, 100000);
    LcP2Fit->SetParameter(1, 2287);
    LcP2Fit->SetParameter(2, 3.5);
    LcP2Fit->SetParameter(3, 4);
    LcP2Fit->SetParameter(4, 0.2);
    LcP2Fit->SetParLimits(4, 0.001, 0.99999);
    LcP2Fit->SetParameter(5, 10);
    LcP2Fit->SetParameter(6, 0.001);
    LcP2Fit->SetParameter(7, -0.001);
    LcP2Fit->SetParameter(8, 5);
    LcP2Fit->SetParameter(9, 1.1);
    LcP2Fit->SetParLimits(8, 0.00000001, 10);
    LcP2Fit->SetParLimits(9, 1.00000001, 10);
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        TF1 *LcP3Fit = new TF1("LcP3Fit",CrystalGaussQuad,2222, 2352,10);
        LcP3Fit->SetParameter(0, 20000);
        LcP3Fit->SetParLimits(0, 10000, 100000);
        LcP3Fit->SetParameter(1, 2287);
        LcP3Fit->SetParameter(2, 3.5);
        LcP3Fit->SetParameter(3, 4);
        LcP3Fit->SetParameter(4, 0.2);
        LcP3Fit->SetParLimits(4, 0.001, 0.99999);
        LcP3Fit->SetParameter(5, 10);
        LcP3Fit->SetParameter(6, 0.001);
        LcP3Fit->SetParameter(7, -0.001);
        LcP3Fit->SetParameter(8, 5);
        LcP3Fit->SetParameter(9, 1.1);
        LcP3Fit->SetParLimits(8, 0.00000001, 10);
        LcP3Fit->SetParLimits(9, 1.00000001, 10);
  ...
  TF1 *LcP4Fit = new TF1("LcP4Fit",CrystalGaussQuad,2222, 2352,10);
  LcP4Fit->SetParameter(0, 20000);
  LcP4Fit->SetParLimits(0, 10000, 100000);
  LcP4Fit->SetParameter(1, 2287);
  LcP4Fit->SetParameter(2, 3.5);
  LcP4Fit->SetParameter(3, 4);
  LcP4Fit->SetParameter(4, 0.2);
  LcP4Fit->SetParLimits(4, 0.001, 0.99999);
  LcP4Fit->SetParameter(5, 10);
  LcP4Fit->SetParameter(6, 0.001);
  LcP4Fit->SetParameter(7, -0.001);
  LcP4Fit->SetParameter(8, 5);
  LcP4Fit->SetParameter(9, 1.1);
  LcP4Fit->SetParLimits(8, 0.00000001, 10);
  LcP4Fit->SetParLimits(9, 1.00000001, 10);
  pad1->cd();
  pad1->Clear();
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    TF1 *LcTau1Fit = new TF1("LcTau1Fit",CrystalGaussQuad,2222, 2352,10);
    LcTau1Fit->SetParameter(0, 30000);
    LcTau1Fit->SetParLimits(0, 10000, 100000);
    LcTau1Fit->SetParameter(1, 2287);
    LcTau1Fit->SetParameter(2, 3.5);
    LcTau1Fit->SetParameter(3, 4);
    LcTau1Fit->SetParameter(4, 0.2);
    LcTau1Fit->SetParLimits(4, 0.001, 0.99999);
    LcTau1Fit->SetParameter(5, 10);
    LcTau1Fit->SetParameter(6, 0.001);
    LcTau1Fit->SetParameter(7, -0.001);
    LcTau1Fit->SetParameter(8, 5);
    LcTau1Fit->SetParameter(9, 1.1);
    LcTau1Fit->SetParLimits(8, 0.00000001, 10);
    LcTau1Fit->SetParLimits(9, 1.00000001, 10);
    ...
    TF1 *LcTau2Fit = new TF1("LcTau2Fit",CrystalGaussQuad,2222, 2352,10);
    LcTau2Fit->SetParameter(0, 30000);
    LcTau2Fit->SetParLimits(0, 10000, 100000);
    LcTau2Fit->SetParameter(1, 2287);
    LcTau2Fit->SetParameter(2, 3.5);
    LcTau2Fit->SetParameter(3, 4);
    LcTau2Fit->SetParameter(4, 0.2);
    LcTau2Fit->SetParLimits(4, 0.001, 0.99999);
    LcTau2Fit->SetParameter(5, 10);
    LcTau2Fit->SetParameter(6, 0.001);
    LcTau2Fit->SetParameter(7, -0.001);
    LcTau2Fit->SetParameter(8, 5);
    LcTau2Fit->SetParameter(9, 1.1);
    LcTau2Fit->SetParLimits(8, 0.00000001, 10);
    LcTau2Fit->SetParLimits(9, 1.00000001, 10);
    ...
    TF1 *LcTau3Fit = new TF1("LcTau3Fit",CrystalGaussQuad,2222, 2352,10);
    LcTau3Fit->SetParameter(0, 30000);
    LcTau3Fit->SetParLimits(0, 10000, 100000);
    LcTau3Fit->SetParameter(1, 2287);
    LcTau3Fit->SetParameter(2, 3.5);
    LcTau3Fit->SetParameter(3, 4);
    LcTau3Fit->SetParameter(4, 0.2);
    LcTau3Fit->SetParLimits(4, 0.001, 0.99999);
    LcTau3Fit->SetParameter(5, 10);
    LcTau3Fit->SetParameter(6, 0.001);
    LcTau3Fit->SetParameter(7, -0.001);
    LcTau3Fit->SetParameter(8, 5);
    LcTau3Fit->SetParameter(9, 1.1);
    LcTau3Fit->SetParLimits(8, 0.00000001, 10);
    LcTau3Fit->SetParLimits(9, 1.00000001, 10);
  ...
  double mag1 = MagDownFit->GetParameter(1);
  double mag2 = MagUpFit->GetParameter(1);
  double magerr1 = MagDownFit->GetParError(1);
  double magerr2 = MagUpFit->GetParError(1);
  ...
  double MagError = 0;
  if (magchi2pdf > 1){
  MagError = FinalFit->GetParError(1) * TMath::Sqrt(magchi2pdf - 1);
  }

  double charge1 = ParticleFit->GetParameter(1);
  double charge2 = AntiParticleFit->GetParameter(1);
  double chargeerr1 = ParticleFit->GetParError(1);
  double chargeerr2 = AntiParticleFit->GetParError(1);
  ...
  if (chargechi2pdf > 1){
  ChargeError = FinalFit->GetParError(1) * TMath::Sqrt(chargechi2pdf - 1);
  }

  double lcp1 = LcP1Fit->GetParameter(1);
  double lcp2 = LcP2Fit->GetParameter(1);
  double lcp3 = LcP3Fit->GetParameter(1);
  double lcp4 = LcP4Fit->GetParameter(1);
  double lcperr1 = LcP1Fit->GetParError(1);
  double lcperr2 = LcP2Fit->GetParError(1);
  double lcperr3 = LcP3Fit->GetParError(1);
  double lcperr4 = LcP4Fit->GetParError(1);
  ...
  double LcPError = 0;
  if (lcpchi2pdf > 1){
  LcPError = FinalFit->GetParError(1) * TMath::Sqrt(lcpchi2pdf - 1);
  }

  double lctau1 = LcTau1Fit->GetParameter(1);
  double lctau2 = LcTau2Fit->GetParameter(1);
  double lctau3 = LcTau3Fit->GetParameter(1);
  double lctau1err = LcTau1Fit->GetParError(1);
  double lctau2err  = LcTau2Fit->GetParError(1);
  double lctau3err  = LcTau3Fit->GetParError(1);
  ...
  double LctauError = 0;
  if (lctauchi2pdf > 1){
  LctauError = FinalFit->GetParError(1) * TMath::Sqrt(lctauchi2pdf - 1);
  }
  ...
  gCharge->GetYaxis()->SetTitle("Measured Mass - Average Mass [MeV]");
  ...
  gLcTau->GetYaxis()->SetTitle("Measured Mass - Average Mass [MeV]");
