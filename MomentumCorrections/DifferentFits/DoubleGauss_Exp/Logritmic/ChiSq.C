...
void ChiSq::Terminate()
{
  ...
  LcTau3->SetLineWidth(2);
    ...
    FinalMass->GetYaxis()->SetTitle("Events / 0.5 MeV");
    PolarityMagUp->GetYaxis()->SetTitle("Events / 0.5 MeV");
    PolarityMagDown->GetYaxis()->SetTitle("Events / 0.5 MeV");
    Particle->GetYaxis()->SetTitle("Events / 0.5 MeV");
    AntiParticle->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcP1->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcP2->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcP3->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcP4->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcTau1->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcTau2->GetYaxis()->SetTitle("Events / 0.5 MeV");
    LcTau3->GetYaxis()->SetTitle("Events / 0.5 MeV");
    ...
    pad2->Draw();
        ...
        lt->DrawLatexNDC(0.60, 0.70, "Signal = "+SignalDGH+" #pm "+SignalErDGH+"");
        lt->DrawLatexNDC(0.60, 0.65, "Fraction in #sigma_{1} = "+FractionDGH+" #pm "+FractionErDGH+"");
        lt->DrawLatexNDC(0.60, 0.60, "#mu = "+muDGH+" #pm "+muErDGH+" MeV");
        lt->DrawLatexNDC(0.60, 0.55, "#sigma_{1} = "+sigma1DGH+" #pm "+sigma1ErDGH+" MeV");
        lt->DrawLatexNDC(0.60, 0.50, "#sigma_{2} = "+rmsDGH+" #pm "+rmsErDGH+" MeV");

        pad2->cd();
        pad2->Clear();
        TH1D* FinalPull = new TH1D("Mass [MeV]", "Lc Mass", 260, 2222, 2352);
        FinalPull->SetStats(0);
        FinalPull->GetXaxis()->SetTitle("m(pKK) [MeV]");
      ...
      MagUpPull->GetXaxis()->SetTitle("m(pKK) [MeV]");
      ...
      c1->SaveAs("LcMMagUp.pdf");
          ...
          pad1->cd();
          pad1->Clear();
          PolarityMagDown->SetMinimum(1.01);
          ...
          MagDownPull->GetXaxis()->SetTitle("m(pKK) [MeV]");
    ...
    ParticlePull->GetXaxis()->SetTitle("m(pKK) [MeV]");
    ...
    c1->SaveAs("LcMParticle.pdf");
        ...
        AntiParticlePull->GetXaxis()->SetTitle("m(pKK) [MeV]");
  ...
  LcP1Pull->SetStats(0);
  LcP1Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
  ...
  c1->SaveAs("LcMLcP1.pdf");
    ...
    LcP2Pull->SetStats(0);
    LcP2Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
    ...
    c1->SaveAs("LcMLcP2.pdf");
        ...
        LcP3Pull->SetStats(0);
        LcP3Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
  ...
  LcP4Pull->SetStats(0);
  LcP4Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
  ...
  c1->SaveAs("LcMLcP4.pdf");
    ...
    LcTau1Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
    ...
    LcTau2Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
    ...
    LcTau3Pull->GetXaxis()->SetTitle("m(pKK) [MeV]");
