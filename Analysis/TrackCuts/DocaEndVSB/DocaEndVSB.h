...
// Thu May  6 17:38:19 2021 by ROOT version 6.18/00
...
class DocaEndVSB : public TSelector {
public :
   ...
   ClassDef(DocaEndVSB,0);

};

#endif

#ifdef DocaEndVSB_cxx
void DocaEndVSB::Init(TTree *tree)
{
