...
// Tue Mar 30 14:36:18 2021 by ROOT version 6.18/00
...
class PIDSelection : public TSelector {
public :
   ...
   PIDSelection(TTree * /*tree*/ =0) { }
   virtual ~PIDSelection() { }
   ...
   ClassDef(PIDSelection,0);

};

#endif

#ifdef PIDSelection_cxx
void PIDSelection::Init(TTree *tree)
{
