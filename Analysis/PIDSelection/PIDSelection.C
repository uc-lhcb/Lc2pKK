...
void PIDSelection::SlaveBegin(TTree * /*tree*/)
{
   ...
   UncutMass->GetXaxis()->SetTitle("m(pKK) [MeV]");
   UncutMass->GetYaxis()->SetTitle("Events / 0.5 MeV");

   PreliminaryMass = new TH1D("", "", 260, 2222, 2352);
   PreliminaryMass->GetXaxis()->SetTitle("m(pKK) [MeV]");
   PreliminaryMass->GetYaxis()->SetTitle("Events / 0.5 MeV");
   PreliminaryBackground = new TH1D("", "", 260, 2222, 2352);
   PreliminaryBackground->GetXaxis()->SetTitle("m(pKK) [MeV]");
   PreliminaryBackground->GetYaxis()->SetTitle("Events / 0.5 MeV");
   PreliminaryBackground->SetFillColor(kRed);
   PreliminarySignal = new TH1D("", "", 260, 2222, 2352);
   PreliminarySignal->GetXaxis()->SetTitle("m(pKK) [MeV]");
   PreliminarySignal->GetYaxis()->SetTitle("Events / 0.5 MeV");
   PreliminarySignal->SetFillColor(kBlue);
   PreliminaryMid = new TH1D("", "", 260, 2222, 2352);
   PreliminaryMid->GetXaxis()->SetTitle("m(pKK) [MeV]");
   PreliminaryMid->GetYaxis()->SetTitle("Events / 0.5 MeV");
   PreliminaryMid->SetFillColor(kYellow);

   PIDBSubedMass = new TH1D("", "", 260, 2222, 2352);
   PIDBSubedMass->GetXaxis()->SetTitle("m(pKK) [MeV]");
   PIDBSubedMass->GetYaxis()->SetTitle("Events / 0.5 MeV");

   ProbNNSignal= new TH1D("", "Signal Region", 120, 0.4, 1.);
   ProbNNBackground = new TH1D("", "Background Region", 120, 0.4, 1.);
   ProbNNSignalEstimate = new TH1D("", "Signal Estimate", 120, 0.4, 1.);
   ...
   ProbNNpVariable->GetYaxis()->SetTitle("Events / 0.005 Probability");
   ProbNNpVariable->GetXaxis()->SetTitle("Proton_ProbNNp");
   ProbNNxVariable= new TH1D("", "", 200, 0., 1.);
   ProbNNxVariable->GetYaxis()->SetTitle("Events / 0.005 Probability");
   ProbNNxVariable->GetXaxis()->SetTitle("Prod_ProbNNx");

   ScatterPlot = new TH2D("", "", 200, 0., 1., 200, 0., 1.);
   ScatterPlot->GetXaxis()->SetTitle("Proton_ProbNNp");
   ScatterPlot->GetYaxis()->SetTitle("Prod_ProbNNx");
   ScatterPlot->GetZaxis()->SetTitle("Events");

   File = new TFile("PIDSelection.root", "RECREATE");
   gFile = File;
...
ScatterPlot->Fill(*Proton_ProbNNp, prodProbNN);
...
void PIDSelection::Terminate()
{
  ...
  TLine *line1 = new TLine(0.6,0,0.6,200000);
  ...
  lt->DrawLatexNDC(0.25, 0.70, "LHCb Preliminary");
  TLine *line2 = new TLine(0.4,0,0.4,200000);
  ...
  ProbNNSignal->GetYaxis()->SetTitle("Events / 0.005 Probability");
  ProbNNSignal->GetXaxis()->SetTitle("Prod_ProbNNx");
  ...
  ProbNNpSignal->GetYaxis()->SetTitle("Events per / 0.005 Probability");
