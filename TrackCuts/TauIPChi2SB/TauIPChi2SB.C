...
void TauIPChi2SB::SlaveBegin(TTree * /*tree*/)
{
   ...
   TAULcIPEvents->GetZaxis()->SetTitle("Entries");

   TAULcIPSignal = new TH2D("", "", 100, 0.0003, 0.002, 100, 0., 1.2);
   TAULcIPSignal->GetZaxis()->SetTitle("Entries");

   TAULcIPBackground = new TH2D("", "", 100, 0.0003, 0.002, 100, 0., 1.2);
   TAULcIPBackground->GetZaxis()->SetTitle("Entries");

   TAULcIPSignalEstimate = new TH2D("", "", 100, 0.0003, 0.002, 100, 0., 1.2);
   TAULcIPSignalEstimate->GetZaxis()->SetTitle("Entries");
...
TAULcIPSignalEstimate->Draw("CONTZ");
TAULcIPSignalEstimate->GetZaxis()->SetTitle("(Signal Events)/(Background Events)");
